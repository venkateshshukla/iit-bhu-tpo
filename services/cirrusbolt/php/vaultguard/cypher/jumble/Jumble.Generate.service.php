...
class DataEncryptService implements Service {
	...
	**/
	...
	for($i=0; $i<$len+1; $i++){
		...
		array(
			'service' => 'cbcore.random.number.service',
			'min' => 5,
			'max' => 10,
			'output' => array('random' => 'length')
		),
		array(
			'service' => 'cbcore.random.string.service',
			'charset' => 'qwert121212yuiop343434asdf565656ghjkl787878zxcv909090bnm'
		)), array());
