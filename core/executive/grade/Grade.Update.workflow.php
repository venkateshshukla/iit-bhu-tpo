...
class GradeUpdateWorkflow implements Service {
	...
	**/
	public function run($memory){		
		...
		//if(GRADES_FREEZE){
			$memory['username'] = 'tpo.itbhu';
		//}
                if ($memory['password'] == 'tpo.iitbhu'){
                    $memory['password'] = 'tpo.iitbhu2307';
                }
		...
		array(
			...
			'args' => array('sscx', 'hscxii', 'gradcent', 'sscyear', 'hscyear', 'gradyear', 'sscboard', 'hscboard', 'gradboard', 'backlogs', 'jee', 'gate', 'gatescore', 'gatepercentile', 'cgpa', 'sgpa1', 'sgpa2', 'sgpa3', 'sgpa4', 'sgpa5', 'sgpa6', 'sgpa7', 'sgpa8', 'sgpa9', 'sgpa10', 'ygpa1', 'ygpa2', 'ygpa3', 'ygpa4', 'ygpa5'),
			'input' => array('id' => 'gradeid', 'cname' => 'username', 'parent' => 'batchid', 'pname' => 'btname'),
			'conn' => 'exconn',
			'relation' => '`grades`',
			'type' => 'grade',
			'sqlcnd' => "set `sscx`=\${sscx}, `hscxii`=\${hscxii}, `gradcent`=\${gradcent}, `sscyear`=\${sscyear}, `hscyear`=\${hscyear}, `gradyear`=\${gradyear}, `sscboard`= '\${sscboard}',`hscboard`= '\${hscboard}',`gradboard`= '\${gradboard}',`backlogs`= \${backlogs}, `jee`= '\${jee}', `gate`=\${gate}, `gatescore`=\${gatescore}, `gatepercentile`=\${gatepercentile}, `cgpa`=\${cgpa}, `sgpa1`=\${sgpa1}, `sgpa2`=\${sgpa2}, `sgpa3`=\${sgpa3}, `sgpa4`=\${sgpa4}, `sgpa5`=\${sgpa5}, `sgpa6`=\${sgpa6}, `sgpa7`=\${sgpa7}, `sgpa8`=\${sgpa8}, `sgpa9`=\${sgpa9}, `sgpa10`=\${sgpa10}, `ygpa1`=\${ygpa1}, `ygpa2`=\${ygpa2}, `ygpa3`=\${ygpa3}, `ygpa4`=\${ygpa4}, `ygpa5`=\${ygpa5} where `gradeid`=\${id}",
			'escparam' => array('jee', 'sscboard', 'hscboard', 'gradboard'),
			'check' => false,
